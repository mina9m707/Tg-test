...
URL | filename | username | password"""
    NOYES_URL = "get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
    ...
    DEL_ETED_CUSTOM_THUMB_NAIL = "✄1�7 Custom thumbnail cleared succesfully."
    FF_MPEG_DEL_ETED_CUSTOM_MEDIA = "✄1�7 Media cleared succesfully."
...
"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this"
